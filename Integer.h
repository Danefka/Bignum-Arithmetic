...
public:
    ...
    bool operator>(const Integer& other) noexcept;
    Integer operator+(const Integer& other) noexcept; // Z-6 ADD_ZZ_Z Першин Артем
    Integer operator-(const Integer& other) noexcept; // Z-7 SUB_ZZ_Z Першин Артем
    Integer operator*(const Integer& other) const noexcept; // Z-8 MUL_ZZ_Z Першин Артем
    Integer operator/(const Integer& other) noexcept; // Z-9 DIV_ZZ_Z Першин Артем
